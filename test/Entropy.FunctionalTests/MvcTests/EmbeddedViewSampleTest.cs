...
{
    public class EmbeddedViewSampleTest : IClassFixture<SampleTestFixture<EmbeddedViewSample.Web.Startup>>
    {
        public EmbeddedViewSampleTest(SampleTestFixture<EmbeddedViewSample.Web.Startup> fixture)
        {
