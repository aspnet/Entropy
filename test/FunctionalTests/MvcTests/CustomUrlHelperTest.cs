...
namespace EntropyTests
{
    ...
    /// </summary>
    public class CustomUrlHelperTests : IClassFixture<SampleTestFixture<UrlHelperSample.Web.Startup>>
    {
        private const string _cdnServerBaseUrl = "http://cdn.contoso.com";

        public CustomUrlHelperTests(SampleTestFixture<UrlHelperSample.Web.Startup> fixture)
        {
