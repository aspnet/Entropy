...
{
    public class SubAreaTests : IClassFixture<SampleTestFixture<MvcSubAreaSample.Web.Startup>>
    {
        public SubAreaTests(SampleTestFixture<MvcSubAreaSample.Web.Startup> fixture)
        {
