...
{
    public class FormatFilterSampleTest : IClassFixture<SampleTestFixture<FormatFilterSample.Web.Startup>>
    {
        ...
        public FormatFilterSampleTest(SampleTestFixture<FormatFilterSample.Web.Startup> fixture)
        {
